...
class Network(nn.Module):
    ...
    def __init__(self, channels=128):
        ...
        self.encoder = AutoModel.from_pretrained("nvidia/MambaVision-L-1K", trust_remote_code=True)
        ...
        self.Global5 = Global(1024, channels)
        self.Global4 = Global(512+channels, channels)
        self.Global3 = Global(256+channels, channels)
        self.Global2 = Global(128+channels, channels)


        self.Global6 = Global_1(1024 + channels, channels)
        self.GL_FI   = GL_FI(channels)



        self.Local5 = Local(1024, channels)
        self.Local4 = Local(512+channels, channels)
        self.Local3 = Local(256+channels, channels)
        self.Local2 = Local(128+channels, channels)
    ...
    def forward(self, x):
        ...
        sout_avg_pool, features = self.encoder(x)
